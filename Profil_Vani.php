...
<p class="text-muted font-size-sm">Jalan mawar, Kabupaten Malang</p>
<p class="text-muted font-size-sm">Jawa Timur</p>
...
<h6></line></svg>E-Wallet Account</h6>

</li>

<ul class="list-group list-group-flush">
<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
<img src="https://jambiindependent.disway.id/upload/12967072b9fb489c3a14dad23487eeb8.jpeg" width="60" alt="ShopeePay" >    
<span class="text-secondary">+994123456789</span>

<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
<img src="https://5minvideo.id/images/kumpulan-gambar-logo-gopay/gopay-logo-png.png" alt="Gojek"  width="60">
<span class="text-secondary">+994123456789</span>
</li>
...
<span class="text-secondary">VaniAzralin</span>
</li>
...
<div class="col-sm-9 text-secondary">
Jalan Mawar, Kabupaten Malang
</div>
</div>
<hr>
<div class="row">
<div class="col-sm-12">
<a class="btn btn-info " target="blank">Edit</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Favorite Shop</i>Vani</h6>
